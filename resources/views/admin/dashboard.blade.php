            ...
            <div class="rounded-2xl border border-gray-200 bg-white px-5 pb-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
                <div class="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
                    ...
                    <div class="relative w-fit">
                        <input class="datepicker h-10 w-full max-w-11 rounded-lg border border-gray-200 bg-white py-2.5 pl-[34px] pr-4 text-theme-sm font-medium text-gray-700 shadow-theme-xs focus:outline-hidden focus:ring-0 focus-visible:outline-hidden dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 xl:max-w-fit xl:pl-11" placeholder="Select dates" data-class="flatpickr-right" readonly="readonly">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <img src="{{ asset('assets/images/country-01.svg') }}" alt="usa">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="w-full max-w-8 items-center rounded-full">
                        <img src="{{ asset('assets/images/country-02.svg') }}" alt="france">
                        </div>
                        <div>
                        <p class="text-theme-sm font-semibold text-gray-800 dark:text-white/90">
                            France
                ...
                <div class="max-w-full overflow-x-auto custom-scrollbar">
                    ...
                    <tbody class="py-3 divide-y divide-gray-100 dark:divide-gray-800">
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                <img src="{{ asset('assets/images/product-02.jpg') }}" alt="Product">
                                </div>
                                <div>
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                    Apple Watch Ultra
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                <img src="{{ asset('assets/images/product-03.jpg') }}" alt="Product">
                                </div>
                                <div>
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                    iPhone 15 Pro Max
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                <img src="{{ asset('assets/images/product-04.jpg') }}" alt="Product">
                                </div>
                                <div>
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                    iPad Pro 3rd Gen
                        ...
                        <td class="px-6 py-3 whitespace-nowrap first:pl-0">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                <img src="{{ asset('assets/images/product-05.jpg') }}" alt="Product">
                                </div>
                                <div>
                                <p class="font-medium text-gray-800 text-theme-sm dark:text-white/90">
                                    Airpods Pro 2nd Gen
